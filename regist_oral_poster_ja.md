...
<!-- - オンサイトでのポスター発表の上限件数は270件です。上限件数以上のオンサイト掲示希望がある場合は学生を優先し、漏れた分は抽選による選考を想定しています。※今回はオンサイト発表数の上限なし--> 
- オンサイトポスター発表を対象としたコアタイムを大会期間中に設けます。<!-- #大会基本情報 のページと重複するが良い？　-->
- オンラインポスター発表を対象としたコアタイムは設けませんが、大会開始前に全てのオンラインポスターを閲覧可能な期間を設けます。
- 博士号未取得の学生会員であれば、[ポスター賞](#ポスター賞)に応募できます（過去にポスター賞審査対象となることができます。<!-- ポスター発表賞→ポスター賞に変更 -->
<!-- - ポスター発表の公募セッションを選択した場合かつオンサイト発表を希望される場合、掲示場所はシンポジウム会場の近くに配置される予定です。※公募セッションのポスターの設置場所については未定-->
...
キャリア初期の若手研究者の研究活動を奨励するために、優秀なポスター発表を行ったものに対してポスター賞を贈ります。本大会では審査員確保の観点から、ポスター賞応募数の上限を500件に設定します。<!-- ポスター賞応募数の上限500件でいいか？-->
賞審査を行わない一般ポスターについては、申込数の上限設定はありません。<!-- 一般ポスターという言葉が分かりにくいかと思ったので補足 -- >
...
- また、公募セッションの「TODO：公募セッションテーマ」を発表分野として希望した講演者も、ポスター賞に応募することはできません。<!-- 公募セッションのポスター発表をするメリットがほとんどない。公募セッションの企画者やシンポジウム発表者に審査をお願いできないか？ -->
- 今大会では、応募者の負担を軽減するため、グラフィカルアブストラクトと説明動画の掲示はポスター賞への応募の要件とはしません。グラフィカルアブストラクトと説明動画の内容は基本的に審査の対象外ですが、審査員が研究内容を理解するために、グラフィカルアブストラクトや説明動画を利用する可能性はあります。
...
- ポスターの情報伝達能力、すなわち研究内容がわかりやすく表示されているかが審査されます。
  例えば、（1）良いタイトル、（2）わかりやすい要旨、（3）視線を引きつける工夫、（4）短時間でおおまかな内容が理解できる<!--今大会では意見交流場がないので「伝えられる」から変更-->工夫などが必要でしょう。そのためには、字・図表が見やすいこと、情報過多でない、説明なしでも要点が理解できることなどが重要です。公平性を期すために、演題タイトルの受付登録後の変更はお控え下さい。<>
...
- ポスター賞の審査は、公平を期すため、オンラインポスターを対象に行います。審査は大会前に行いますので、指定された期日（3月11日23:59を予定）までに必ずONLINE CONF上にポスターをアップロードしてください。アップロードしたポスターの修正は可能です。
- 今回のオンラインポスター発表では、グラフィカルアブストラクト、ポスター本体、補足資料（PDF）、説明動画をアップロードすることが可能となっていますが、このうち審査の対象となるのはポスター本体だけとなります（オンサイトにも掲示する場合でも、審査対象はオンラインポスターのみ）。
<!-- また、このオンラインポスター本体は、「A4横向き×４枚程度」の形式で作成されたものを想定しています。-->
...
<!-- 上の3点については発表の諸注意のページにも類似の記述をするが、ここにもあった方が親切かなと思い加えました -->
...
- 日本語を理解しない研究者に対して配慮がなされているかも考慮します。審査の際には使用言語に関わらずポスターの内容についてのみ評価しますが、審査の結果同票だったポスターについては英語による理解が可能なポスターの順位を繰り上げます。英語による理解が可能なポスターとは、タイトルやイントロおよび結論に英語が併記されている場合、英語を読むだけで研究の概要を理解できる場合、ポスター内の言語を英語に変更したポスター（英語版ポスター）が別ページに用意されている場合等が該当します。
...
### オンサイトポスターの発表方法
- オンサイトポスターの掲示に使用されるボードのサイズは縦210cm×横90cmで、A0縦型のポスターを掲示可能です。演者はこのスペースを自由に利用可能です。
